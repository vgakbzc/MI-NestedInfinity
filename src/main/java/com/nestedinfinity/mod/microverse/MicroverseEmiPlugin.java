...
public final class MicroverseEmiPlugin implements EmiPlugin {
    ...
    public void register(EmiRegistry registry) {
        ...
        registry.addRecipe(new StructureRecipe());
    ...
    /**
     * The multiblock itself as its own page: an exploded isometric diagram
     * of the 7x3x7 structure (generated by tools/gen_microverse_assets.py
     * from the same layout MicroverseStructure validates), a legend of the
     * four parts, and a per-layer build description.
     */
    private static final class StructureRecipe implements EmiRecipe {
        private static final int WIDTH = 168;
        /** Keep in sync with the generator's cropped output. */
        private static final int DIAGRAM_W = 89;
        private static final int DIAGRAM_H = 111;
        private static final EmiTexture DIAGRAM = new EmiTexture(
                id("textures/gui/emi/projector_structure.png"),
                0, 0, DIAGRAM_W, DIAGRAM_H, DIAGRAM_W, DIAGRAM_H, DIAGRAM_W, DIAGRAM_H);
        private static final int LEGEND_Y = 118;
        private static final int LABEL_Y = 138;
        private static final int TEXT_X = 6;
        private static final int TEXT_WIDTH = 156;
        private static final int TEXT_Y = 150;
        private static final int LINE_HEIGHT = 10;
        private static final String[] TEXT_KEYS = {"title", "bottom", "middle", "top"};
        ...
        public ResourceLocation getId() {
            return id("microverse_projector/structure");
        }
        ...
        public int getDisplayHeight() {
            ...
            for (String key : TEXT_KEYS) {
                lines += font.split(text(key), TEXT_WIDTH).size();
            }
            return TEXT_Y + lines * LINE_HEIGHT + (TEXT_KEYS.length - 1) * 2 + 5;
        }
        ...
        public void addWidgets(WidgetHolder widgets) {
            widgets.addTexture(DIAGRAM, (WIDTH - DIAGRAM_W) / 2, 4);
            widgets.addSlot(controller, 12, LEGEND_Y);
            widgets.addSlot(EmiStack.of(MicroverseBlocks.TDUS.get(4).get(), 4), 54, LEGEND_Y);
            widgets.addSlot(EmiStack.of(MicroverseBlocks.NEUTRONIUM_MACHINE_CASING.get(), 50), 96, LEGEND_Y);
            widgets.addSlot(EmiStack.of(MicroverseBlocks.COREFLAMES.get(1).get()), 138, LEGEND_Y);
            widgets.addText(text("legend.controller"), 6, LABEL_Y, TEXT_COLOR, false);
            widgets.addText(text("legend.tdu"), 48, LABEL_Y, TEXT_COLOR, false);
            widgets.addText(text("legend.casing"), 90, LABEL_Y, TEXT_COLOR, false);
            widgets.addText(text("legend.flames"), 132, LABEL_Y, TEXT_COLOR, false);
            int y = TEXT_Y;
            for (String key : TEXT_KEYS) {
